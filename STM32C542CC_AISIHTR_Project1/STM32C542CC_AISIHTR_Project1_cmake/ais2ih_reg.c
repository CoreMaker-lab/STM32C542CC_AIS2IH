                              ...
                              ais2ih_mode_t val)
{
  ...
  if (ret == 0)
  {
    ctrl6.low_noise = ((uint8_t) val >> 4) & 0x01U;
...
{
  ais2ih_ctrl1_t ctrl1 = {0};
  ais2ih_ctrl3_t ctrl3 = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ctrl3.slp_mode = ((uint8_t)val >> 4) & 0x03U;
...
int32_t ais2ih_auto_increment_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    reg.if_add_inc = (uint8_t)val & 0x01U;
    ret = ais2ih_write_reg(ctx, AIS2IH_CTRL2, (uint8_t *) &reg, 1);
  }
                                   ...
                                   ais2ih_drdy_pulsed_t val)
{
  ...
  if (ret == 0)
  {
    reg.drdy_pulsed = (uint8_t)val & 0x01U;
    ret = ais2ih_write_reg(ctx, AIS2IH_CTRL7, (uint8_t *) &reg, 1);
  }
...
int32_t ais2ih_filter_path_set(const stmdev_ctx_t *ctx,
                               ais2ih_fds_t val)
{
  ais2ih_ctrl6_t ctrl6 = {0};
  ais2ih_ctrl7_t ctrl_reg7 = {0};
  int32_t ret = {0};
...
int32_t ais2ih_reference_mode_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    reg.hp_ref_mode = (uint8_t)val & 0x01U;
    ret = ais2ih_write_reg(ctx, AIS2IH_CTRL7, (uint8_t *) &reg, 1);
  }
                           ...
                           ais2ih_cs_pu_disc_t val)
{
  ...
  if (ret == 0)
  {
    reg.cs_pu_disc = (uint8_t)val & 0x01U;
    ret = ais2ih_write_reg(ctx, AIS2IH_CTRL2, (uint8_t *) &reg, 1);
  }
                                  ...
                                  ais2ih_ctrl4_int1_pad_ctrl_t *val)
{
  ...
  ais2ih_ctrl5_int2_pad_ctrl_t ctrl5_int2_pad_ctrl = {0};
  ais2ih_ctrl7_t reg = {0};
  int32_t ret = {0};
...
{
  ais2ih_ctrl7_t ctrl_reg7 = {0};
  ais2ih_ctrl4_int1_pad_ctrl_t  ctrl4_int1_pad = {0};
  int32_t ret = {0};
...
int32_t ais2ih_all_on_int1_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    reg.int2_on_int1 = (uint8_t)val & 0x01U;
    ret = ais2ih_write_reg(ctx, AIS2IH_CTRL7, (uint8_t *) &reg, 1);
  }
...
int32_t ais2ih_wkup_dur_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    reg.wake_dur = (uint8_t)val & 0x03U;
                                  ...
                                  ais2ih_usr_off_on_wu_t val)
{
  ...
  if (ret == 0)
  {
    reg.usr_off_on_wu = (uint8_t)val & 0x01U;
    ret = ais2ih_write_reg(ctx, AIS2IH_CTRL7, (uint8_t *) &reg, 1);
  }
...
{
  ais2ih_wake_up_ths_t wake_up_ths = {0};
  ais2ih_wake_up_dur_t wake_up_dur = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ...
    wake_up_dur.stationary = ((uint8_t)val >> 1) & 0x01U;
                                     ...
                                     ais2ih_tap_prior_t val)
{
  ...
  if (ret == 0)
  {
    reg.tap_prior = (uint8_t)val & 0x07U;
    ret = ais2ih_write_reg(ctx, AIS2IH_TAP_THS_Y, (uint8_t *) &reg, 1);
  }
                                      ...
                                      uint8_t val)
{
  ...
  if (ret == 0)
  {
    reg.tap_z_en = (uint8_t)val & 0x01U;
    ret = ais2ih_write_reg(ctx, AIS2IH_TAP_THS_Z, (uint8_t *) &reg, 1);
  }
                                      ...
                                      uint8_t val)
{
  ...
  if (ret == 0)
  {
    reg.tap_y_en = (uint8_t)val & 0x01U;
    ret = ais2ih_write_reg(ctx, AIS2IH_TAP_THS_Z, (uint8_t *) &reg, 1);
  }
                                      ...
                                      uint8_t val)
{
  ...
  if (ret == 0)
  {
    reg.tap_x_en = (uint8_t)val & 0x01U;
    ret = ais2ih_write_reg(ctx, AIS2IH_TAP_THS_Z, (uint8_t *) &reg, 1);
  }
                                ...
                                ais2ih_lpass_on6d_t val)
{
  ...
  if (ret == 0)
  {
    reg.lpass_on6d = (uint8_t)val & 0x01U;
    ret = ais2ih_write_reg(ctx, AIS2IH_CTRL7, (uint8_t *) &reg, 1);
  }
...
{
  ais2ih_wake_up_dur_t wake_up_dur = {0};
  ais2ih_free_fall_t free_fall = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    wake_up_dur.ff_dur = ((uint8_t) val >> 5) & 0x01U;
...
int32_t ais2ih_fifo_watermark_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    reg.fth = (uint8_t)((uint8_t)val & 0x1F);
